// Slide 19 — Direction Alignment (RQ3 · cosine similarity)
// Theme: Claude Code UI — matches slides 1, 2, 15, 16, 17, 18.
...
(async () => {
  ...
  pres.title  = "Direction Alignment — Probe vs SAE";
  ...
  const stats = [
    {
      big: "−0.22",
      label: "cos(W,  SAE #14733)",
      sub: "sign correct · moderate magnitude",
    },
    {
      big: "0.017",
      label: "RANDOM BASELINE |cos|",
      sub: "noise floor across 1,000 random features",
    },
    {
      big: "13×",
      label: "SIGNAL OVER NOISE",
      sub: "alignment is real, not coincidence",
    },
  ];
  ...
  const plots = [
    {
      file: path.join(PLOTS, "sae_all_cosines_hist.png"),
      cap: "Cosines across all 16,384 SAE features · #14733 marked",
    },
    {
      file: path.join(PLOTS, "sae_cosine_alignment.png"),
      cap: "Top-20 features by training |corr| — clear alignment",
    },
    {
      file: path.join(PLOTS, "sae_correlation_vs_alignment.png"),
      cap: "|correlation| vs |cosine| — two methods agree",
    },
  ];
  ...
  slide.addText(
    "Both methods point in the same general direction — alignment is real, but no single SAE feature is the probe direction.",
    {
  ...
  await pres.writeFile({ fileName: "slide_19.pptx" });
  console.log("Saved slide_19.pptx");
})();
